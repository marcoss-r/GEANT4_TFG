...
output_dir = "./particlegen/input_article3/"
...
for energy in energies_MeV:
    ...
    output_file = os.path.join(output_dir, f"input_particles_{energy_int}MeV_neutron.csv")
    ...
    data = {
        ...
        'pos_x_m': np.random.uniform(0, 0, n_events),
        'pos_y_m': [height] * n_events,  # Altura fija
        'pos_z_m': np.random.uniform(0, 0, n_events),
